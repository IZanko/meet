...
const credentials = {
  ...
  redirect_uris: ["https://izanko.github.io/meet/"],
  javascript_origins: ["https://izanko.github.io", "http://localhost:3000"],
};
...
module.exports.getCalendarEvents() = async (event) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    oAuth2Client.getCalendarEvents(access_token, calendar.events.list(
      {
